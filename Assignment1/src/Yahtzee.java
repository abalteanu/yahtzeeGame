...
public class Yahtzee {
	...
	/**
	 * Helper/Accessor method that gets the array of the five dice and each of their values 
	...
	private int smStraight() {
        int score = 0;
        int consecutiveCount = 1; // counts the number of consecutive numbers 
	 ...
	 * Aces, Twos, Threes, Fours, Fives, Sixes, 3 of a kind, 4 of a kind, full house, small straight, large straight, Yahtzee (5 of a kind), and chance
	...
	/**
	 * Method that determines the best score out all the score options
	 * @return returnArray, an array of two values, containing the largest number of points attainable, and the index at which this occurs in the getScoreOptions array
	 */
	public int[] score() {
	...
	/**
	 * Method that determines if one Yahtzee game class is equal to another by checking if the value count for each game is the same 
	 * The dice values' themselves do not need to be checked, because the order does not matter. What matters is that the same values appear the same number of times
	 * @param other, the Yahtzee class to be compared
	 * @return equal, a boolean that mentions whether or not this Yahtzee class and the other Yahtzee class are equal
	 */
	...
	/**
	 * toString method that turns the dice values into a legible string
	 * @return arrayF, the final string that can be seen by the user
	 */
